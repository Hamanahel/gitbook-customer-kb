...
\
The deployment is done on a dedicated cloud account opened for the client and while Hamanahel charges a setup fee and deployment fees annually, the cost of Infrastructure is billed at cost.<br>

### Regions

Enterprise deployments can be deployed with any cloud vendor providing VPS services. However, we do recommend using AWS or at least vendors with managed RDBMS services like Amazon RDS.<br>
